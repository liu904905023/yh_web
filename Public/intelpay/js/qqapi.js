!function (a, b, c) {
    ...
    function f(b, c, d, e, f) {
        if (b && c && d) {
            ...
            f && (O[f] = {from: "reportAPI", ns: c, method: d, uri: k, startTime: Date.now()}, j = String(f).match(/__MQQ_CALLBACK_(\d+)/), j && (O[j[1]] = O[f])), C.send(k, S)
        }
    }
    ...
    }()), a.iOS = H.test(D), a.android = I.test(D), a.iOS && a.android && (a.iOS = !1), a.version = "20161228005", a.QQVersion = "0", a.clientVersion = "0", a.ERROR_NO_SUCH_METHOD = "no such method", a.ERROR_PERMISSION_DENIED = "permission denied", a.compare = function (b) {
        ...
        function b() {
            ...
            d = [], f = 0, g.length && (k.appid = h, k.typeid = i, k.releaseversion = l, k.sdkversion = a.version, k.qua = m, k.frequency = j, k.t = Date.now(), k.key = ["commandid", "resultcode", "tmcost"].join(","), g.forEach(function (a, b) {
                k[b + 1 + "_1"] = a[0], k[b + 1 + "_2"] = a[1], k[b + 1 + "_3"] = a[2]
                    ...
                    mqq.iOS ? mqq.invokeClient("data", "pbReport", {type: String(10004), data: k}) : mqq.invokeClient("publicAccount", "pbReport", String(10004), k)
    ...
    iOS: function (a, b) {
        return "object" == typeof a ? mqq.invokeClient("app", "launchApp", a) : mqq.invokeClient("app", "launchApp", {appID: a, paramsStr: b})
    }, android: function (a) {
        ...
        if (mqq.compare("4.6") >= 0) {
            ...
            mqq.__reportAPI("web", "device", "getClientInfo"), a({
                isMobileQQ: !0, systemName: "android", systemVersion: function (a) {
                    return a && a[1] || 0
                }(c.match(/\bAndroid ([\d\.]+)/i)), model: function (a) {
                    return a && a[1] || null
    ...
    function a(a, c) {
        "string" == typeof a && /^{.*?}$/.test(a) && (a = JSON.parse(a)), a && "radio" in a && (1 === a.type ? a.radio = "wifi" : a.type >= 2 ? a.radio = b[a.radio] || a.radio : a.radio = "unknown"),
        c && c(a)
    }
...
}), mqq.build("mqq.device.networkStatus", {iOS: mqq.device.getNetworkType, supportInvoke: !0, support: {iOS: "4.5"}}), mqq.build("mqq.device.networkType", {
...
}), mqq.build("mqq.device.webviewType", {iOS: mqq.device.getWebViewType, supportInvoke: !0, support: {iOS: "4.6"}}), mqq.build("mqq.device.isMobileQQ", {
    iOS: function (a) {
    ...
    function c(a, b) {
        var c = {sid: g, appid: a.substring(a.lastIndexOf(".") + 1), platid: h, qqver: i, format: "json", _: (new Date).getTime()}, d = "get_new_msg_cnt";
        try {
            Zepto.ajax({
    ...
    function c(a, b) {
        var c = {sid: g, appid: a.substring(a.lastIndexOf(".") + 1), platid: h, qqver: i, format: "json", _: (new Date).getTime()}, d = "read_msg";
        try {
            Zepto.ajax({
                type: "get", url: j + d, dataType: "json", data: c, timeout: 1e4, success: function (a) {
        ...
        if (0 == a.code) {
            ...
            if (d = "object" != typeof d && "" != d ? JSON.parse(d) : d, "undefined" != typeof d.msg) {
                ...
                if (a.data.buffer = JSON.stringify(d), e.length > 0) {
                    ...
                    var k = a.data.appID, m = {sid: g, appid: k, platid: h, qqver: i, format: "json", _: (new Date).getTime()}, n = "read_msg";
                    try {
                        Zepto.ajax({
                            type: "get", url: j + n, dataType: "json", data: m, timeout: 1e4, success: function (a) {
                            }, error: function () {
                            }
                        })
                    } catch (o) {
    ...
    iOS: function (a) {
        ...
        a.data = {title: a.title, icon: a.icon, url: a.url}, a.callback = mqq.callback(a.callback), mqq.invokeClient("ui", "addShortcut", a)
    }, supportInvoke: !0, support: {iOS: "5.8", android: "5.8"}
        ...
        iOS: function (c) {
            if (a(c.url)) {
                ...
                2 === c.target ? mqq.invokeClient("nav", "openLinkInSafari", {url: d}) : 1 === c.target ? (c.styleCode = {
                                ...
                                2: 2,
                                3: 5
                            }[c.style] || 1, mqq.invokeClient("nav", "openLinkInNewWebView", {url: d, options: c})) : window.open(d, "_self")
            }
        }, android: function (c) {
            if (a(c.url)) {
                c || (c = {});
