    ...
    <div class="page">
        ...
        <div id="main">
            <div class="main js-main">
				...
				<input type="hidden" name="CustomerSysNO" value="<?php echo ($CustomerSysNO); ?>">
            </div>
        </div>
...
<script type="text/javascript" src="/Public/newwxpay/js/qq-b4a55416_ali.min.js" defer="true" async="true" crossorigin></script>
