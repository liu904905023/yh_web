    ...
    <div class="page">
        <div id="storeInfo">
            <div class="store-info">
                ...
                <div class="store-info__name-container"><p><?php echo ($Customer); ?></p>
            ...
            <div class="main js-main">
                <div class="main__amount">
                    ...
                    <div class="main__amount__number">
                        <span class="currency">&yen;</span><span class="amount js-amount-view"></span><span class="cursor js-cursor"></span><input placeholder="" name="amount" id="amount"
                                                                                                                                                   type="hidden" readonly>
                    </div>
                </div>
                <div class="main__activity-notify js-main__activity-notify">门店：<?php echo ($systemUserName); ?></div>
				<input type="hidden" value="<?php echo ($openid); ?>" name ="openid">
				<input type="hidden" value="<?php echo ($systemUserSysNo); ?>" name ="systemUserSysNo">
...
<script type="text/javascript" src="/Public/wft/js/qq-b4a55416.min.js" defer="true" async="true" crossorigin></script>
