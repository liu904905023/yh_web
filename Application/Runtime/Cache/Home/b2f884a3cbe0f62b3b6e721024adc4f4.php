    ...
    <div class="page">
        ...
        <div id="main">
            <div class="main js-main">
                ...
                <div class="main__activity-notify js-main__activity-notify">门店：<?php echo ($systemUserSysNo); ?></div>
            </div>
        </div>
...
<script type="text/javascript" src="/Public/newwxpay/js/qq-b4a55416.min.js" defer="true" async="true" crossorigin></script>
